...
library(httr)
dir_gh  = '~/github/cdz/webapps_templates'
...
for (f in c('regions.brew.md',   # ohi-science.org/cdz/regions -> renders with layers/rgn_labels.csv
            'layers.brew.md',    # ohi-science.org/cdz/layers  -> renders with layers.csv
            'goals.brew.md',     # ohi-science.org/cdz/goals   -> renders with conf/goals.Rmd
            'scores.brew.md'     # ohi-science.org/cdz/scores  -> renders with scores.csv
)){
